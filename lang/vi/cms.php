...
return [
    ...
    'file' => [
        ...
        'cache_cleared' => 'Đã dọn dẹp bộ nhớ tạm hình ảnh.',
        'restored' => 'Khôi phục tệp thành công.',
        'folder_created' => 'Tạo thư mục thành công.',
        'uploaded' => 'Tải lên tệp thành công.',
        'updated' => 'Cập nhật tệp thành công.',
        'deleted' => 'Xóa tệp thành công.',
        'extracted' => 'Giải nén tệp thành công.',
    ...
    'settings' => [
        ...
        'general_saved' => 'Đã lưu cấu hình hệ thống.',
        'search_console_saved' => 'Đã lưu cấu hình Google Search Console.',
